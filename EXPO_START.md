...
- [ ] **Page 3**: Profil énergétique (4 options) - Clique sur une option
- [ ] **Page 3_feedback**: Auto-advance après 2 sec
- [ ] **Page 4**: Douleur personnelle (3 options) - Clique sur une option
- [ ] **Page 4_reassurance**: Auto-advance après 3 sec
...
- [ ] **Page 8**: Inputs (Nom plante + Personnalité select) - Remplis et valide
- [ ] **Page 8_confirmation**: Auto-advance après 2.5 sec
...
Quand tous les tests passent, l'onboarding est prêt pour production ! 🎉
